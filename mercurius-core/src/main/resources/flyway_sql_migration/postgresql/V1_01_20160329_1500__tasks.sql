...
CREATE UNIQUE INDEX INDEX_PROPERTY_UUID_IDX ON SOLR_INDEX_TASK_PROPERTIES(uuid);
CREATE UNIQUE INDEX INDEX_PROPERTY_CODE_IDX ON SOLR_INDEX_TASK_PROPERTIES(code);
CREATE INDEX  INDEX_PROPERTY_NAME_IDX ON SOLR_INDEX_TASK_PROPERTIES(name);
...
CREATE UNIQUE INDEX SOLR_SEARCH_RESOLVER_UUID_IDX ON SOLR_SEARCH_RESOLVERS(uuid);
CREATE UNIQUE INDEX SOLR_SEARCH_RESOLVER_CODE_IDX ON SOLR_SEARCH_RESOLVERS(code);
CREATE INDEX  SOLR_SEARCH_RESOLVER_NAME_IDX ON SOLR_SEARCH_RESOLVERS(name);
...
CREATE UNIQUE INDEX SOLR_INDEX_FIELD_UUID_IDX ON SOLR_INDEX_FIELDS(uuid);
CREATE UNIQUE INDEX SOLR_INDEX_FIELD_CODE_IDX ON SOLR_INDEX_FIELDS(code);
CREATE INDEX  SOLR_INDEX_FIELD_NAME_IDX ON SOLR_INDEX_FIELDS(name);
