...
public interface CatalogUniqueCodeEntityService {
     ...
     */
    <T extends CatalogUniqueCodeEntity> T getEntityByCode(String code, Class<T> clazz, String... fetchFields);
     ...
     * @return Catalog unique code entity
     */
    <T extends CatalogUniqueCodeEntity> T getEntityByCodeAndCatalog(String code, CatalogEntity catalog, Class<T> clazz);
     ...
     * @return Catalog unique code entity
     */
    <T extends CatalogUniqueCodeEntity> T getEntityByCodeAndCatalogWithFetch(String code, CatalogEntity catalog, Class<T> clazz, String... fetchFields);
     ...
     * @return Catalog unique code entity
     */
    <T extends CatalogUniqueCodeEntity> T getEntityByCodeAndCatalogCodeWithFetch(String code, String catalogCode, Class<T> clazz, String... fetchFields);
}
